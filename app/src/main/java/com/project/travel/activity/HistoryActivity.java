...
import com.project.travel.model.HistoryModel;
import com.project.travel.adapter.HistoryAdapter;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    public void refreshList() {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            hasil.add(new HistoryModel(id_book, tanggal, riwayat, total, R.drawable.profile1));
        }
